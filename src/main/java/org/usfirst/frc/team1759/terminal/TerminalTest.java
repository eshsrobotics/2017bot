...
public class TerminalTest {
        ...
        /**
         * The amount of time that the 'listen' sub-command listens before signaling the server thread to quit.
         */
        final static int DEFAULT_TIMEOUT_MILLISECONDS = 15000;

        /**
         * The group of (name, curve fitter) pairs that the 'fit' sub-command recognizes.
         */
        final static Map<String, AbstractCurveFitter> algorithms = new HashMap<String, AbstractCurveFitter>();

        /**
         * @param args The command-line arguments.  args[0] is the sub-command.
         */
