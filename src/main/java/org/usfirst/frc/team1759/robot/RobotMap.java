...
public class RobotMap {
	...
	public static final int front_left_wheel = 0; // Port for the motor
													// associated with our front
													// left wheel
	public static final int back_left_wheel = 1; // Port for the motor
													// associated with our back
													// left wheel
	public static final int front_right_wheel = 2; // Port for the motor
													// associated with our front
													// right wheel
	public static final int back_right_wheel = 3; // Port for the motor
													// associated with our back
													// right wheel
	public static final int shoot_wheel = 4; // Port for the motor associated
												// with our shooter
	public static final int feed_wheel = 5; // Port for the motor associated
											// with our feed wheel
	...
	public static final double littleAdjust = 0.05; // For making little
													// adjustments.
	public static final long shooterTime = 3500; // Time given to the shooter to
													// build up speed
